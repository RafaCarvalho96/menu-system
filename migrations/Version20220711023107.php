 ...
 */
final class Version20220711023107 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__menu AS SELECT id, store_id, name FROM menu');
        $this->addSql('DROP TABLE menu');
        $this->addSql('CREATE TABLE menu (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, store_id INTEGER NOT NULL, name VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_7D053A93B092A811 FOREIGN KEY (store_id) REFERENCES store (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO menu (id, store_id, name) SELECT id, store_id, name FROM __temp__menu');
