 ...
 */
final class Version20220710211517 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__store AS SELECT id, name, description, phone, address FROM store');
        ...
        $this->addSql('INSERT INTO store (id, name, description, phone, address) SELECT id, name, description, phone, address FROM __temp__store');
